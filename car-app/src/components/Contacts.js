...
export default function Contacts() {
	...
	function SelectedPath(e) {
		if (e.target.id === 'PL-MA') {
			...
			setTitle('Rzeszów');
			setCityInfo(
				'The business partner decided to build a company here because he saw the market for these products in demand'
			);
					...
					<article className="oftenAsk">
						<div className="questions">
							<div className="questions__content">
								<h3 className="questions__mainTitle">Frequently asked questions</h3>

								<div className="question">
									<h3 className="question__title" onClick={() => setQuestionOne(!questionOne)}>
										How to choose cars
									</h3>
									{questionOne && (
										<p className="question__text">
											In front pannel you have possibilities to find you dream car.Using filter
											method you are able to choose car by price and mark and car state.
										</p>
									)}
								</div>

								<div className="question">
									<h3 className="question__title" onClick={() => setQuestionTwo(!questionTwo)}>
										How to buy new car
									</h3>
									{questionTwo && (
										<p className="question__text">
											It's very simple. When you add car to basket you have to go throught all
											purchasing steps. Remeber about create an account beouse it's requiere.
											Afterwards you will add personal data and address your delivery. In the end
											you will have option to pay.
										</p>
									)}
								</div>

								<div className="question">
									<h3 className="question__title" onClick={() => setQuestionThree(!questionThree)}>
										Problem with purchasing
									</h3>
									{questionThree && (
										<p className="question__text">
											If you will have some problem send us feedback on email: nice.car@gmail.com
											. Our teem supports contact with you as soon as it possible.
										</p>
									)}
								</div>

								<div className="question">
									<h3 className="question__title" onClick={() => setQuestionFourth(!questionFourth)}>
										You can't find match car
									</h3>
									{questionFourth && (
										<p className="question__text">
											Have you some problem with find your dream car. No problem. Send us feedback
											with nam your car. We send you feedback with information about abilitity
											this car in our shop.
										</p>
									)}
								</div>
							</div>
