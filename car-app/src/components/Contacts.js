...
export default function Contacts() {
  ...
  const [cityInfo, setCityInfo] = useState(
    "Select one region for more information about our company in this area."
  );
  ...
  function SelectedPath(e) {
    if (e.target.id === "PL-MA") {
      ...
      setTitle("Łódź");
      setCityInfo(
        "The capital of our business. Together with 'Encompy z.o.o we buit 250k cars last year.'"
      );
    } else if (e.target.id === "PL-LU") {
      setTitle("Lublin");
      setCityInfo(
        "Here we started selling Audi cars, which turned out to be a good decision."
      );
    } else if (e.target.id === "PL-LB") {
      setTitle("Zielona Góra");
      setCityInfo(
        "We employ 2k people in this company and even now we need more employees."
      );
    } else if (e.target.id === "PL-MZ") {
      setTitle("Warszawa");
      setCityInfo(
        "First bussiness contract with abroad partner has been writed just here."
      );
                ...
                <div className="question">
                  ...
                  {questionOne && (
                    <p className="question__text">
                      ...
                      car.Using filter method you are able to choose car by
                      price and mark and car state.
                    </p>
                  )}
                </div>
                ...
                <div className="question">
                  ...
                  {questionTwo && (
                    <p className="question__text">
                      ...
                      go throught all purchasing steps. Remeber about create an
                      account beouse it's requiere. Afterwards you will add
                      personal data and address your delivery. In the end you
                      will have option to pay.
                    </p>
                  )}
                </div>
                ...
                <div className="question">
                  ...
                  {questionThree && (
                    <p className="question__text">
                      ...
                      nice.car@gmail.com . Our teem supports contact with you as
                      soon as it possible.
                    </p>
                  )}
                </div>
                ...
                <div className="question">
                  ...
                  {questionFourth && (
                    <p className="question__text">
                      ...
                      problem. Send us feedback with nam your car. We send you
                      feedback with information about abilitity this car in our
                      shop.
                    </p>
                  )}
                </div>
