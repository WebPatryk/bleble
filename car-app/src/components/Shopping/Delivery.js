...
export default function Delivery({ prevStep, nextStep, handleDelivery }) {
	...
	return (
		<ThemeProvider theme={theme}>
			<DeliveryStyle>
				<h1 className="delivery__title">1.Choose one of the method of delivery</h1>

				<form>
					<figcaption className="delivery__deliverer">
						<input type="radio" id="curier" name="delivery" onChange={handleRadioChange} />
						...
						<input type="radio" id="parcel" name="delivery" onChange={handleRadioChange} />
								...
								{parcel && (
									<>
										<form onSubmit={handleSubmitParcel}>
											<h1 className="delivery__parcel-title">Choose your parcel</h1>
											...
											<>
												...
												{error && <h1 className="error">We can't find parcel here</h1>}
												{loading && <Loading />}
											</>
										</form>
									</>
					...
					<div className="delivery-methods">
						...
						<label htmlFor="PayPal">
							<div className="delivery__box">
								...
								{payPal && (
									<i className="delivery__text">In the next page you will abel to pay by PayPal.</i>
								)}
							</div>
						</label>
					</div>
