        ...
        <Account>
            ...
            {!localStorage.getItem('username') ?
                <div className="account__container">
                    ...
                    <Link to='sign-in' className="btn account__login-btn ">Login to your account</Link>
                    <p className="account__preposition">Or</p>
                    <Link to='register' className=" btn account__register-btn">Register</Link>

                    <IconContext.Provider value={{ size: "2rem", style: { marginRight: "2rem" } }}>
                        <h1 className="account__main-title">Why it worth it have an account</h1>
                        <div>
