		...
		<header className="header__content">
			<main className="header__huge-content">
				<div className="header__content-rectangle">
					...
					<img src={smallTriangle} alt="triangle" className="header__content-small-triangle" />
				</div>

				<figure className="header__content-services">
					<h1>Sercives</h1>
					<figcaption>Mercedes,Audi,Lexus are avilble in our serciveces</figcaption>
				</figure>
				...
				<img src={mercedes} alt="background logo mercedes" className="header__content-car" />

				<h1 className="header__photo-describtion"> The most popular and speed car</h1>
