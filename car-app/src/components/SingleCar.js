            ...
            <div className="details__box">
              ...
              <article className="details__box-content">
                ...
                <IconContext.Provider
                  value={{ size: "3rem", className: "car-icon" }}
                >
                      ...
                      <div className="detail__box-row">
                        <div className="detail__box-row-left">
                          ...
                          <p className="detail__box-parts">
                            <AiOutlineGlobal />
                            Country:{" "}
                            <span className="detail__box-data">{country}</span>
                          </p>
                        </div>
                        <div className="detail__box-row-right">
                          ...
                          <p className="detail__box-parts">
                            <AiFillStar />
                            State:{" "}
                            <span className="detail__box-data">{state}</span>
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="detail__box-row ">
                        <div className="detail__box-row-left">
                          ...
                          <p className="detail__box-parts">
                            <AiFillDashboard />
                            Speed:{" "}
                            <span className="detail__box-data">{Power} KM</span>
                          </p>
                        </div>
                        <div className="detail__box-row-right ">
                          <p className="detail__box-parts">
                            <AiOutlineSlack />
                            Gearbox:{" "}
                            <span className="detail__box-data">{Gearbox}</span>
                          </p>
                          <p className="detail__box-parts">
                            <AiTwotoneAppstore />
                            Number of places:{" "}
